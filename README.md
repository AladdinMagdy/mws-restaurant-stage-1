...
3. With your server running, visit the site: `http://localhost:8000` I used port 3001 but you can change port at dbhelper.js, and look around for a bit to see what the final experience looks like.
